...
<html><head>
        ...
        <title>Gestión de Personal - Analisis y diseño</title>
                    ...
                    <div class="container">
                        ...
                        <li class="registro-display">
                            ...
                            <ul class="submenu-hijo2" style="display:none;">
                             ...
                             <li><a href="" data-toggle="modal" data-target="#registrarEmpleado">Registrar Personal</a></li>
                            </ul>
                        </li>                        
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="heading wow fadeIn animated" data-wow-offset="120" data-wow-duration="1.5s">
                            <div class="title text-center"><h1>Gestión de personal</h1></div>
                            <div class="subtitle text-center "><h5>Aquí podrás ver y modificar el personal de tus obras</h5></div>
                            <div class="separator text-center"></div>
                        </div>
                        <?php include('listar_personal.php'); ?>
